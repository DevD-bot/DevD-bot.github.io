...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Devyansh, also known as DevD. I'm a software engineer at Videonetics, previously at Schlumberger (SLB) and Osmosys. I'm passionate about backend, cloud, and competitive programming.\nCheck out my GitHub: https://github.com/DevD-bot and LinkedIn: https://linkedin.com/in/devyansh-singh-devd.",
    src: '/profil-raph.png',
    fallbackSrc:
